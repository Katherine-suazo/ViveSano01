...
class ProductoForm(forms.Form):
    ...
    precio_producto = forms.DecimalField(label='Precio',required=True,min_value=0.01,max_value=10000000, widget=forms.NumberInput(attrs={'class': 'form-control','placeholder': '0.00','step': '0.01'}))
    stock_producto = forms.IntegerField(label='Stock',min_value=0,max_value=100000,required=True,widget=forms.NumberInput(attrs={'class': 'form-control','placeholder': '0','min': '0'}))
