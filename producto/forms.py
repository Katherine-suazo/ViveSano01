...
class ProductoForm(forms.Form):
    ...
    precio_producto = forms.DecimalField(label = 'Precio', required= True, min_value=0.01, widget= forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '0.00', 'step': '0.01'}))
