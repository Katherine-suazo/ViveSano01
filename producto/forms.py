...
class ProductoForm(forms.Form):
    ...
    stock_producto = forms.IntegerField(label = 'Stock', required = True, widget = forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '0', 'min': '0'}))
    fecha_vencimiento_producto = forms.DateField(label = 'Fecha de venc (aaaa-mm-dd)', required = True, widget = forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}))
